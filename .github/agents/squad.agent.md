...
- **Version:** 0.9.6-build.4 (see HTML comment above — this value is stamped during install/upgrade). Include it as `Squad v0.9.6-build.4` in your first response of each session (e.g., in the acknowledgment or greeting).
